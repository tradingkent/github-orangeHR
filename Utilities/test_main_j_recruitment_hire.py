...
from Pages.orangeHR_recruitment_hire import RecHireCandidate
...
class TestRecruitment():
    ...
    @pytest.mark.tags('All', 'TS4_TC3', 'rec_hire')
    ...
    @pytest.mark.tags('All', 'TS4_TC4', 'rec_hire')
    def test_hire_add_candidate(self):
        ...
        sss_name = ss_folder + timestamp + '_ss_hire_add_candidate.png'
        self.driver.save_screenshot(sss_name)

    @pytest.mark.tags('All', 'TS4_TC5', 'rec_hire')
    def test_search_candidate(self):

        # Verify Hire Search Candidate
        add_vacancy = RecAddVacancy(self.driver, self.wait)
        hire_add_cand = RecAddCandidate(self.driver, self.wait)
        ...
        sss_name = ss_folder + timestamp + '_ss_search_candidate.png'
        self.driver.save_screenshot(sss_name)

    @pytest.mark.tags('All', 'TS4_TC6', 'rec_hire')
    def test_tag_shortlist(self):

        # Verify Hire Tag as Shortlisted
        ...
        sss_name = ss_folder + timestamp + '_ss_tag_shortlist.png'
        self.driver.save_screenshot(sss_name)

    @pytest.mark.tags('All', 'TS4_TC7', 'rec_hire')
    def test_sched_interview(self):

        # Verify Hire Schedule an interview
        ...
        sss_name = ss_folder + timestamp + '_ss_sched_interview.png'
        self.driver.save_screenshot(sss_name)

    @pytest.mark.tags('All', 'TS4_TC8', 'rec_hire')
    def test_cand_passed(self):

        # Verify Hire Pass Candidate
        cand_pass = RecPassCandidate(self.driver, self.wait)

        cand_pass.click_cand_pass_button()
        cand_pass.click_save_cand_pass()

        sss_name = ss_folder + timestamp + '_ss_cand_passed.png'
        self.driver.save_screenshot(sss_name)

    @pytest.mark.tags('All', 'TS4_TC9', 'rec_hire')
    def test_cand_offer_job(self):

        # Verify Hire Candidate Offer Job
        ...
        sss_name = ss_folder + timestamp + '_ss_cand_offer_job.png'
        self.driver.save_screenshot(sss_name)

    @pytest.mark.tags('All', 'TS4_TC10', 'rec_hire')
    def test_cand_hire(self):

        # Verify Hire
        hire_cand = RecHireCandidate(self.driver, self.wait)
        del_cand = RecDelCandidate(self.driver, self.wait)
        add_vacancy = RecAddVacancy(self.driver, self.wait)
        hire_add_cand = RecAddCandidate(self.driver, self.wait)
        search_cand = RecSearchCandidate(self.driver, self.wait)

        hire_cand.click_hire_button()
        hire_cand.click_save_button_hire()

        sss_name = ss_folder + timestamp + '_ss_cand_hire.png'
        self.driver.save_screenshot(sss_name)
        ...
        sss_name = ss_folder + timestamp + '_ss_del_cand.png'
        self.driver.save_screenshot(sss_name)
